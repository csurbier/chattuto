...
export const domainConfig = {
  client: 'chattuto',
  virtual_host: 'https://app-9f1bd1e5-8657-422c-bea8-552add54a8ec.cleverapps.io/',
  domainApp: 'https://app-9f1bd1e5-8657-422c-bea8-552add54a8ec.cleverapps.io/',
...
export class ApiserviceService {
  ...
  */
  ...
  sendFcmToken(userId,tokenId, deviceName, typeDevice) {
    const options = {
        headers: new HttpHeaders({
